    ...
    return(
      ...
      <div className='flex flex-wrap items-center gap-5 w-full'>
        ...
        <div id="collapseMenu"
          ...
          <ul
            ...
            <li className='max-lg:border-b max-lg:py-3 px-3'><Link href='/team'
              className='lg:hover:text-[#007bff] text-gray-800 block font-semibold text-[15px]'>Team</Link>
            </li>
            <li className='max-lg:border-b max-lg:py-3 px-3'><Link href='/about'
              className='lg:hover:text-[#007bff] text-gray-800 block font-semibold text-[15px]'>About</Link>
            </li>
            <li className='max-lg:border-b max-lg:py-3 px-3'><Link href='/blog'
              className='lg:hover:text-[#007bff] text-gray-800 block font-semibold text-[15px]'>Blog</Link>
            </li>
          </ul>
        </div>
        ...
        <div className='flex lg:ml-auto max-lg:w-full'>
          <div
            className='flex xl:w-80 max-xl:w-full bg-gray-100 px-4 py-3 rounded outline outline-transparent border focus-within:border-blue-600 focus-within:bg-transparent transition-all'>
